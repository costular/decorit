package com.costular.decorit.util.view
...
class ColorView @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        drawable = requireNotNull(ContextCompat.getDrawable(context, R.drawable.ic_check)) {
            "There was a problem with check drawable"
        }
    }
